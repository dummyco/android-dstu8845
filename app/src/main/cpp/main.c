...
Java_me_dummyco_dstu8845_MainActivity_main(JNIEnv *env, jobject thiz) {
    ...
    __android_log_print(ANDROID_LOG_VERBOSE, "main", "Encrypted 15GB in %f seconds\n", time_spent);
    __android_log_print(ANDROID_LOG_VERBOSE, "main", "Speed is %f Gb/s\n", ((1 / ((time_spent * 1.0) / 15)) * 8));
